...
public class UserProductIntegrationTest {
    ...
    void test1() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            productService.createProduct(requestDto, userId); // 멤버 변수 userId 초기값이 그대로 적용되면서 null 값이 들어간다.
        });
    ...
    void test2() {
        ...
        // 회원 정보가 저장될 때 암호화가 되는데, 입력된 패스워드의 암호화랑 같은지 비교
        // .encode로 비교하는게 아니라 .matches 로 비교해야함
